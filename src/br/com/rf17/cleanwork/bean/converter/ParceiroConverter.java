...
public class ParceiroConverter implements Converter {
	...
	public Object getAsObject(FacesContext facesContext, UIComponent component,
		...
		if (submittedValue.trim().equals("") || submittedValue.trim().equals("null")) {
			...
			try {
				return new ParceiroDao().getById(Long.parseLong(submittedValue));
			} catch (NumberFormatException exception) {
				throw new ConverterException(new FacesMessage(FacesMessage.SEVERITY_ERROR, "Conversion Error","Parceiro não é valido!"));
			} catch (Exception e) {
				throw new ConverterException(new FacesMessage(FacesMessage.SEVERITY_ERROR, "Conversion Error","Parceiro não é valido!"));
			}
		}		
	...
	public String getAsString(FacesContext facesContext, UIComponent component,
		...
		if (value == null || value.equals("")) {
			...
			return String.valueOf(((Parceiro) value).getId_parceiro());
		}
	}
}